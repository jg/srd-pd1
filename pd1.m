...
etapy = N:-1:1;
stany = 500:500:300000; % saldo na koncie na poczštku etapu
sterowania = 0:0.01:1; % procentowy udział operacji walutowych w etapie k
zaklocenia  = [0.5 0.3;1 0.3; 1.4 0.3; 2 0.1]'; % pary: (zakłócenie, prawdopodobienstwo zaklocenia)
